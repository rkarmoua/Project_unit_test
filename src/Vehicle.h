...
#include <iostream> 
#include <string>
#include "../lib/googletest/googletest/include/gtest/gtest_prod.h"
using namespace std;
/*
...
protected:
	...
	*/
 //FRIEND_TEST(Cargas, CarMake);
FRIEND_TEST(getYear, test5);
FRIEND_TEST(setYear,test6);
FRIEND_TEST(checkChargePowerTest, void0);
FRIEND_TEST(VehicleTest, GetOdometerTest);
FRIEND_TEST(setOdometerTest, Void1);
FRIEND_TEST(VehicleTest, GetCarInformationTest);
FRIEND_TEST(VehicleTest, Getters);
FRIEND_TEST(VehicleTest, Setters);
	string m_make;
	string m_model;
	int m_year;
	int m_odometer;
